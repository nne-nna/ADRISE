export const Services = () => {
  ...
  return (
    <section className="px-6 py-14 max-w-6xl mx-auto relative">
      ...
      <div className="w-fit mx-auto text-center mt-20 mb-24">
      ...
      <div className="relative grid md:grid-cols-3 gap-4 mb-20">
        <div className="absolute top-[-100px] left-0 right-0 mx-auto w-[70%]">
          <img
        ...
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-[#5954DA3B] border border-[#FFFFFF33] rounded-2xl p-8 my-36 text-center relative z-10 
        ...
        <div className="absolute bottom-[-100px] left-0 right-0 mx-auto w-[70%]">
          <img
