export const AITools = () => {
  ...
  return (
    <section className="px-6 max-w-6xl mx-auto text-white min-h-screen">
      ...
      <div className="space-y-8">
        {tools.map((tool, index) => (
          <div
            key={index}
            className={`flex items-center gap-20 bg-[#15192C] rounded-3xl p-8 w-full relative ${
              index === 0
          ...
          >
            <div className="w-1/2 pr-8 font-aloevera">
              <div className="mb-4">
                <img
                  src={tool.icon}
                  alt={`${tool.title} icon`}
