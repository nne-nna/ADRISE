...
export const HeroSection = () => {
  ...
  return (
    <section className="relative px-6 pt-15 pb-6 text-center max-w-6xl mx-auto">
      <div className="relative z-10">
        ...
        <h1 className="text-5xl font-bold font-akira mb-6 tracking-wide hover:scale-[1.02] transition-transform duration-500 cursor-default">
        ...
        <p className="text-gray-400 text-sm font-aloevera-light mb-16 hover:text-gray-300 transition-colors duration-300">
          ...
          <div className="p-[2px] rounded-lg bg-gradient-to-r from-[#A083FF] to-[#3C8BD9] hover:from-purple-400 hover:to-blue-400 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25 hover:scale-[1.02] group">
            <div className="flex items-center space-x-6 bg-gray-800 hover:bg-gray-750 rounded-lg px-1 py-2 transition-colors duration-300">
              <input
                ...
                className="bg-transparent w-80 text-white font-aloevera-light text-sm placeholder-gray-400 focus:outline-none focus:placeholder-gray-300 transition-colors duration-300"
              />
